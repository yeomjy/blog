...
A geometric $p$-simplex $[v_0, v_1, \cdots, v_p]$ is a convex hull of $\{v_0, \cdots, v_p\}$,
i.e.,

$$
    [v_0, v_1, \cdots, v_p] = \left\{ \sum_{i=0}^{p} t_i v_i : 0\leq t_i \leq 1, \quad \sum_{i} t_i = 1 \right\}
$$

and we define $i$th boundary face as
